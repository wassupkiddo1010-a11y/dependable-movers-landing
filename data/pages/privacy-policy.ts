...
export const privacyPolicyPage: MigratedPage = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "Analytics — Google Analytics and related conversion tracking services — Personal Data: Cookies; Usage Data; unique device identifiers.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "The Service is not directed to children under the age of 13. Users declare themselves to be adult according to their applicable legislation. Minors may use this Website only with the assistance of a parent or guardian. Under no circumstance may persons under the age of 13 use this Website.",
    },
    {
      type: "p",
      text: "No mobile information will be shared with third parties or affiliates for marketing or promotional purposes. Information sharing to subcontractors in support services, such as customer service, is permitted. All other use case categories exclude text messaging originator opt-in data and consent.",
    },
  ],
};
